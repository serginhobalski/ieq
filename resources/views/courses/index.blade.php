                        ...
                        <div class="card-body p-0 d-flex flex-column justify-content-between">
                            ...
                            <div class="row g-0 mb-3 align-items-end">
                                ...
                                <div class="col-auto pe-3">
                                    <a 
                                        class="btn btn-sm btn-falcon-default me-2 hover-danger"
                                        href="{{route('courses.show', $course->id)}}" data-bs-toggle="tooltip" data-bs-placement="top"
                                        title="Visualizar Curso">
                                        <span class="far fa-edit" data-fa-transform="down-2"></span>
                                    </a>
                                    <a
                                        class="btn btn-sm btn-falcon-default hover-danger"
                                        data-bs-toggle="tooltip" data-bs-placement="top" title="Deetar Curso"
                                    ...
                                    <form id="logout-form" action="{{ route('courses.destroy', $course->id) }}" method="POST" class="d-none">
                                        @method('DELETE')
                                        @csrf
                                        <button 
                                            class="btn btn-sm btn-falcon-default hover-primary" 
